...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.has(config.mod.vmute) && !message.member.hasPermission("ADMINISTRATOR")) return message.channel.send("Bu komutu kullanamak için yeterli yetkin bulunmamaktadır.")
...
if(!sebep) sebep = "sebep girilmemiş.";
 ...
 member.voice.setMute(false);
    ...
    let embed = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(`
        **Bir üyenin Ses Mutesi kaldırıldı**
...
exports.configuration = {
    CommandName: ["v-unmute","vunmute"],
    description: "vunmute yaparsınız",
    usage: "vunmute [member] [sebep]"
};
